...
To build the final jar and optimize the SMSEmailNotificationApi application for production, run:
...
Then navigate to [http://localhost:6001](http://localhost:6001) in your browser.
